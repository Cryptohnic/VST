...
//==============================================================================
const juce::String VSTAudioProcessor::getName() const
{
...
const juce::String VSTAudioProcessor::getProgramName (int index)
{
    return {};
}

void VSTAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void VSTAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* VSTAudioProcessor::createEditor()
{
...
//==============================================================================
void VSTAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
ChainSettings getChainSettings(juce::AudioProcessorValueTreeState &apvts){
    ...
    // get real time values based on our ranges
...
juce::AudioProcessorValueTreeState::ParameterLayout VSTAudioProcessor::createParameterLayout(){
// 3 EQ bands - Low, High, and Peak
// Controllable Frequency/Slope, Gain, and Quality
